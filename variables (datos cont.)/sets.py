...
# nota. Aqui no puedes tener datos mutables(que puedan cambiarse de forma simple), como ser una lista o array por ejemplo
# ej. set(['hola',['que','tal']])   <---- aqui tenemos un array que pueda mutarse, lo que provoca un array
